...
/**
 * Payload para editar una zona. {@code plantId} y {@code code} no son
 * editables (forman la unique key). El polígono debe tener al menos 3
 * vértices.
 */
public record SafetyZoneUpdateDto(
